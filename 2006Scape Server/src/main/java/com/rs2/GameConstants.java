...
public class GameConstants {
	 ...
	 */
	public static String FILE_SYSTEM_DIR = "./data/cache/";
	...
	static {
		NetworkConstants.RSA_EXPONENT = new BigInteger("");
		NetworkConstants.RSA_MODULUS = new BigInteger("");			
	}
}