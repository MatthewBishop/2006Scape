...
import net.runelite.api.mixins.ParaArg;
import net.runelite.api.mixins.ParaInvoker;
import net.runelite.api.mixins.ParaMethod;
import net.runelite.api.mixins.ParaSetter;
import net.runelite.api.mixins.ParaSetterVerbose;
...
//		return;
	...
	//NOTE: Do not change the ordering of these arguments or it will mess up the hooks.xml generated by the annotation processor.
	
	@ParaMethod("pushMessage")
	public void pushMessage(@ParaArg(1)String s, @ParaArg(2)int i, @ParaArg(0) String s1) {
		if (i == 0 && dialogID != -1) {
			aString844 = s;
			super.clickMode3 = 0;
		}
...
//			}
			...
			int k = onDemandFetcher.getVersionCount(0);
